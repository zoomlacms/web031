<%@ page language="C#" autoeventwireup="true" inherits="test, App_Web_oiavnysv" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <asp:DropDownList ID="SchList_Radio" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="SchList_Radio_SelectedIndexChanged" DataTextField="SchoolName" DataValueField="ID">
            </asp:DropDownList>
            <select name="class_rad" class="form-control">
    ...
    <div id="setteach_div" style="display:none;">
        <div class="text-center">
            <asp:DropDownList ID="TeacList_Dr" runat="server" DataTextField="TName" DataValueField="ID" CssClass="form-control"></asp:DropDownList>
            <asp:TextBox ID="Date_T" runat="server" CssClass="form-control" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd' });" placeholder="代课日期"></asp:TextBox>
