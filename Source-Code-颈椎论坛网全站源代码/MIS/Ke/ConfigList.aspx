<%@ page language="C#" autoeventwireup="true" inherits="User_Class_ConfigList, App_Web_oiavnysv" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ZL:ExRepeater ID="RPT" runat="server" PageSize="10" PagePre="<tr><td><input type='checkbox' id='chkAll'/></td><td colspan='8'><div class='text-center'>" OnItemCommand="RPT_ItemCommand" PageEnd="</div></td></tr>">
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#Eval("weekday") %></td>
                    <td>
                        <a href="SchConfig.aspx?id=<%#Eval("ID") %>">修改</a>
                        <asp:LinkButton runat="server" CommandName="Del"  OnClientClick="return confirm('是否删除!')" CommandArgument='<%#Eval("ID") %>'>删除</asp:LinkButton>
                    </td>
                </tr>
            </ItemTemplate>
