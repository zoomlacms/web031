<%@ page language="C#" autoeventwireup="true" inherits="test_test, App_Web_oiavnysv" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-bordered table-striped">
        <tr><td class="td_m">学校名称:</td>
            <td>
                <asp:TextBox runat="server" ID="SchoolName_T" CssClass="form-control"/>
            </td></tr>
        ...
        <tr><td>学校类型:</td><td>
            ...
            <asp:Button runat="server" ID="Save_Btn" Text="保存" CssClass="btn btn-xs btn-primary" OnClientClick="return CheckData();" OnClick="Save_Btn_Click" />
        </td></tr>
    </table>
