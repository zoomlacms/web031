<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_PreViewOrder, App_Web_quycjq5s" clientidmode="Static" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <iframe src="/Class_1/NodeElite.aspx" onload="this.height = $(this).contents().height() + 'px';" frameborder="0" scrolling="no" width="100%" id="user_frame"></iframe>
    <div runat="server" id="DV_show">
        ...
        <div class="us_topinfo hidden" style="margin-top: 10px;">
