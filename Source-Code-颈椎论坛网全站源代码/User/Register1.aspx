<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_aie0qeud" enableviewstatemac="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html lang="zh-CN">
<head>
...
#TableRegisterSelect tr:nth-child(12){ display:none;}
#TableRegisterSelect tr:nth-child(14){ display:none;}
#TableRegisterSelect tr:nth-child(16){ display:none;}
#TableRegisterSelect tr:nth-child(18){ display:none;} 
</style>
...
<%Call.Label("{ZL.Label id=\"全站头部\"/}"); %>
    <form id="form1" runat="server">
        ...
        <div class="navbar navbar-fixed-top" style="background-color: #004b9b; display:none;">
            <div class="container">
...
//                            });
                        ...
                        <div class="reg_sub"><!--注册用户--补全信息--注册成功(替换为图片形式)-->
                            <h1><span class="glyphicon glyphicon-user"></span>注册患者会员</h1>
                            <ul>
                                <li>
                                    <div class="form-group">
                        ...
                        <asp:Literal ID="Literal2" runat="server"></asp:Literal>～<asp:Literal ID="Literal1" runat="server"></asp:Literal>个字符之间</span>
                            ...
                            <ul>
                                ...
                                <li class="hidden">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                            <asp:TextBox ID="TxtAnswer" runat="server" Text="123" CssClass="form-control required" />
                                        </div>
                                        <div class="col-sm-4 col-lg-4 col-md-4 col-xs-12 padding0  text-left">
                            ...
                            <ul >
                                <li style="display:none;">
                                    <div class="metro btn btn-primary" title="显示选填信息" onload="SwicthSelectFill();" id="disBtn" ><span class="glyphicon glyphicon-resize-vertical" ></span>显示用户选填信息 </div>
                                </li>
                            </ul>
                            <ul class="field_ys">
                                <li>
                                    <div>
                                        <table style="border-collapse: collapse;" id="TableRegisterSelect" cellspacing="1" cellpadding="2" width="100%" border="0" runat="server">
                                            <tr>
