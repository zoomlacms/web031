<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Comment.CommentFor, App_Web_ronjkcir" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html>
<head>
<title>发表评论</title>
<meta charset="utf-8">
...
<body>
    <form id="form1" runat="server">
        <div class="container-fluid" style="position:relative;">
                            ...
                            <div class="panel-heading">我也来说两句<div class="pull-right gray_c">评论还可以输入<span id="maxcount_span">320</span>字</div></div>
                                <div class="CommentPK" style="display:none;">
                                    ...
                                    <div class="hidden">
                                        ...
                                        <img id="VCodesender_img" runat="server" title="点击刷新验证码" class="code" />
                                ...
                                <ZL:ExRepeater ID="RPT" runat="server" PageSize="10" PagePre="<li style='width:100%' class='text-center margin_t10'>" PageEnd="</li>">
                                    <ItemTemplate>
                                        <li class="list-group-item" style="width:100%;">
                                            <h5 class="list-group-item-heading"><%#GetHead(Eval("CommentID"))%>评论人：<%# GetUserName(Eval("UserID","{0}")) %>  <span class="text-right comm-date">发表时间：<%# Eval("CommentTime") %></span></h5>
            ...
            <div class="Assis_Div">
                <a class="info" id="setup" title="顶" href="javascript:;" onclick="ContentAssist(1)">
                    <span class="glyphicon glyphicon-thumbs-up hand"></span>
                ...
                <a class="info" id="setdown" title="踩" href="javascript:;" onclick="ContentAssist(-1)">
                    <span class="glyphicon glyphicon-thumbs-down hand"></span>
        ...
        <style>
            ...
            .Assis_Div .info {border:1px solid #ccc; color:#999; padding:10px; font-size:20px; display:block; text-decoration:none; text-align:center; width:80px;}
        </style>
