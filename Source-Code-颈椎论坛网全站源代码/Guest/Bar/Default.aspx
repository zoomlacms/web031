<%@ page language="C#" autoeventwireup="true" inherits="Guest_Bar_BarList, App_Web_yu5ymvsg" masterpagefile="~/Guest/Guest.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="row">
<div>
<h5 class="well well-sm" style=" display:none"><strong>社区热点</strong>
<div class="pull-right" style=" display:none">今日:<asp:Label runat="server" ID="TCount_L"></asp:Label>  昨日:<asp:Label runat="server" ID="YCount_L"></asp:Label></div>
</h5>
<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 padding_l_r0" style=" display:none">
...
<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12" style=" display:none">
