<%@ page language="C#" autoeventwireup="true" inherits="Guest_Bar_PostList, App_Web_yu5ymvsg" masterpagefile="~/Guest/Guest.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<style>
.tie_list .tie_rel_count div:nth-child(2) a{ display:none;}
.tie_list .tie_rel_count { overflow:hidden; width:160px;}
.tie_list .tie_rel_count div{ float:left;}
.tie_list .tie_rel_count .uname{ width:60px;}
.tie_list .tie_rel_count div:nth-child(1){ width:80px;}
.tie_list .tie_rel_count div:nth-child(2){ width:20px;}
.tie_list .tie_rel_count div:nth-child(2) .glyphicon{ display:none;}
.tie_list .subtitle{ display:none;}
</style>
</asp:Content>
