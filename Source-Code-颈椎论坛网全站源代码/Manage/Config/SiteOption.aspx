<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_SiteOption, App_Web_3dmrjzhm" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox runat="server" ID="DupTitleNum_T" CssClass="form-control text_x" Text="6" />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="Savanumlog" runat="server"  CssClass="form-control"></asp:TextBox>
                            <span>条 (<%:lang.LF("0-不限制") %>)</span></td>
                    </tr>
                    <tr>
                        <td><strong><%:lang.LF("保留日志天数") %>：</strong></td>
                        <td>
                            <asp:TextBox ID="Savadaylog"  runat="server" CssClass="form-control"></asp:TextBox>
                    ...
                    <tr runat="server" id="Tr1">
                        ...
                        <td>
                            <asp:TextBox ID="Videourl" runat="server" CssClass="form-control"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td><strong><%:lang.LF("评论积分赠送") %>：</strong></td>
                        <td>
                            <asp:TextBox ID="CommentRule"  runat="server" CssClass="form-control"></asp:TextBox>
                            <span>分</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPdf" runat="server"  CssClass="form-control"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtAdvertisementDir"  runat="server" CssClass="form-control"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="MastMoney" runat="server"  CssClass="form-control"></asp:TextBox></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 200px"><strong><%:lang.LF("首页生成后缀") %>：</strong></td>
                        <td>
...
<%--                    <tr>
                    ...
                    <tr>
                        <td style="width: 200px"><strong><%:lang.LF("留言本是否需要登录") %>：</strong></td>
                        <td>
