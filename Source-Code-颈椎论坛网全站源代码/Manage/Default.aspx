<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_aq2idg0w" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html>
<head>
...
<ul class="menu2">
	...
	<li class="menu2_6"><a onclick="showleft('menu2_6','Content/Video/VideoList.aspx')"><%:lang.LF("视频管理") %></a></li>
    <li class="menu2_5">
        <div class="btn-group topdrop">
...
<ul class="menu6">
    ...
    <li class="menu6_8"><a onclick="ShowMain('UserGuide.ascx','User/UserApi.aspx')">站群用户整合</a></li>
</ul>
<ul class="menu7">
...
<%--                                    <li><a href="javascript:;"><%:lang.LF("微博管理") %></a> </li>--%>
			...
			<li>
				...
				<ul style="position: relative; display: none;">
					...
					<li><a data-dismiss="modal" onclick="showleft('menu9_7','Workload/WorkCount.aspx')" href="javascript:;"><%:lang.LF("工作统计") %></a></li>
...
<div id="left_ul_div">
	...
	<div id="menu3" class="m_left_ul">
		...
		<ul id="menu3_13" class="m_left_ulin">
			...
			<li id="menu3_13_4"><a href="javascript:ShowMain('UserShopNodeTree.ascx','Shop/ProductManage.aspx?StoreID=-1',this);"><%:lang.LF("商家商品管理") %></a></li>
