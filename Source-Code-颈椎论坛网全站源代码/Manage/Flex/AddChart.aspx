<%@ page language="C#" autoeventwireup="true" inherits="manage_Flex_Chart, App_Web_sick1nqr" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
	...
	<tr>
		...
		<td align="left">
			<textarea id="TbBase" style="height: 300px; width: 500px;" class="form-control" runat="server">1,2,3|a,b,c</textarea>
