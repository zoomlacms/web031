<%@ page language="C#" autoeventwireup="true" inherits="Manage_Content_Video_VideoInfo, App_Web_ycnmxeqx" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="VName_T" CssClass="form-control" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="text-right">视频大小:</td>
            <td>
                <asp:TextBox ID="VSize_T" CssClass="form-control" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="text-right">视频长度:</td>
            <td>
                <asp:TextBox ID="VTime_T" CssClass="form-control" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="CDate_T" CssClass="form-control" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="text-right">备注:</td>
            <td>
                <asp:TextBox ID="Desc_T" CssClass="form-control" runat="server" TextMode="MultiLine" Rows="4"></asp:TextBox>
            </td>
        </tr>
        <tr>
