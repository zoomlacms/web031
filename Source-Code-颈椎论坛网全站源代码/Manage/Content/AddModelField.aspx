<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddModelField, App_Web_snavgufp" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<tbody runat="server" id="DivMultipleTextType" style="display: none">
    ...
    <tr><td><strong>附加功能：</strong></td>
        <td><asp:CheckBox runat="server" id="MText_SelUser_Chk" Text="允许选择用户" /></td>
    </tr>
</tbody>
<!--  多行文本(支持Html)    -->
...
<tbody id="DivImages" style="display: none">
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" id="IsWater_Images" checked="checked" class="switchChk" runat="server" />
            </td>
        </tr>
    </tbody>
<!--  多图片    -->
