<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_CollectionInfoPage, App_Web_tgku1j5m" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr class="tdbg">
            <td colspan="2">
				...
				<input type="button" value="取消" class="btn btn-primary" onclick="window.close();" />
            </td>
        </tr>
    </table>
