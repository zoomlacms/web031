<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Guest_GradeOption, App_Web_1y0j1chh" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
    <tr>
        <td class="tdbgleft" style="width:10%;height: 21px;text-align:right">
                所属分类：
        </td>
        <td>
