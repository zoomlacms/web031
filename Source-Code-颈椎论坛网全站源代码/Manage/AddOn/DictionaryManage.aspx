<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.DictionaryManage, App_Web_1x45aesl" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <tr>
        ...
        <asp:Button ID="btnSave" runat="server" Text="添加分类" OnClick="btnSave_Click" class="btn btn-primary"/>
        </td>
    </tr>                
</table>   
