<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.GradeCateManage, App_Web_013bhz2g" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
	...
	<tr>
		...
		<td>
			<asp:TextBox ID="txtGradeField" runat="server"  
