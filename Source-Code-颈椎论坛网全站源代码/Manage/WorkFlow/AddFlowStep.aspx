<%@ page language="C#" autoeventwireup="true" inherits="Manage_WorkFlow_AddFlowStep, App_Web_1unkpe1h" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div id="Addstep" runat="server">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td>转交:</td>
                <td><span>经办人未办理完毕时是否允许主办人强制转交:</span>
    ...
    <script>
        ...
        function UserFunc(json){
            ...
            for (var i = 0; i < json.length; i++) {
                data+=json[i].UserName+",";
            }
            $("#"+$("#dataField").val()+"T").val(data);
            diag.CloseModal();
        }
        function hidediv()
        {
