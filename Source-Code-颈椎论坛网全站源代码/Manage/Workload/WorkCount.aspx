<%@ page language="C#" autoeventwireup="true" inherits="Manage_Workload_WorkCount, App_Web_4sa4cvhq" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<%@ Register TagPrefix="uc"TagName="NodeList"Src="~/Manage/I/ASCX/NodeTree.ascx"%>
        ...
        <div class="col-lg-2 col-md-2 col-sm-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <uc:NodeList ID="Lists" Url="Workload/WorkCount.aspx" runat="server" />
                </div>
            </div>
        </div>
    ...
    <script>
        $().ready(function () {
            $(".tvNav li a").click(function () {
                $(".tvNav li a").removeClass("SelectedA");
        ...
        function InitData() {
            ...
            $("#DataTable").fadeOut(200, function () {
                $.ajax({
                    type: "POST",
                    url: $("#NodeID_hid").val(),
                    data: { action: "groupcount", year: $("[name='years']:checked").val(), month: $("[name='months']:checked").val(), mid: $("[name='model']:checked").val() },
        ...
        function InitDrawTool() {
            ...
            $("#draw_ifr").attr("src", "/Plugins/Chart/line.aspx?Bases=1200|300|" + year + month + "统计报表|无&Datas={" + (DataObj.CurYear!="-1"?DataObj.CurYear+"年":"全部") + "|" + value + "|" + days + "}");
