<%@ page language="C#" autoeventwireup="true" inherits="manage_Workload_Subject, App_Web_4sa4cvhq" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div id="t1" runat="server">
        ...
        <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False"  
                ...
                <Columns> 
                    ...
                    <ItemTemplate>
                        <a href="javascript:;" title="查看">查看</a>
                    </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
        ...
        <ZL:ExGridView runat="server" ID="ExGridView1" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False"  
                ...
                <Columns>                      
                    <asp:TemplateField >                         
                        <ItemTemplate> 
                            <span><%#Eval("AdminId") %></span>
                            <a href="/Admin/Workload/Subject.aspx?Type=manager&Rid=<%#Eval("AdminId") %>"><%#Eval("AdminName") %></a>
                            </ItemTemplate>
                        </asp:TemplateField>                                                      
                </Columns>
                <PagerStyle HorizontalAlign="Center" />
