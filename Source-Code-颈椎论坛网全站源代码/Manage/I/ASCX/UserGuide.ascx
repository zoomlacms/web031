<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_UserGuide, App_Web_aeterwuk" %>
...
<div class="left_ul">
	...
	<li class="guideli"><a onclick="ShowMain('','APP/Suppliers.aspx')">社会化登录</a></li>
