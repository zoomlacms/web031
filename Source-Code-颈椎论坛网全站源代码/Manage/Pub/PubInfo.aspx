            ...
            <ContentTemplate>
                ...
                <tr runat="server" id="PubTemplates">
                    ...
                    <td align="left" width="80%">
                        ...
                        <input type="button" value="选择模板" onclick="ShowDiag('../Template/TemplateList.aspx?OpenerText=' + escape('PubTemplate') + '&amp;FilesDir=', '选择模板')" class="btn btn-primary">
                ...
                <tr id="PubInputTMs" runat="server">
                    ...
                    <td align="left" width="80%">
                        ...
                        <input type="button" value="选择模板" onclick="ShowDiag('../Template/TemplateList.aspx?OpenerText=' + escape('PubInputTM') + '&amp;FilesDir=', '选择模板')" class="btn btn-primary">                     
                        <font color="blue">添加时如果为空则自动创建</font>
                    </td>
                </tr>
