<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Guest_BarConfig, App_Web_jra5mvot" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="tab-content">
            ...
            <tr class="barFile_div onlybar">
                ...
                <td>
                    <div class="input-group" style="width:500px;">
                        ...
                        <span class="alert alert-info input-group-addon padding0"> 0为不压缩,如输入2048,则超过2M的图片会自动等比压缩 </span>
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <div class="text-center">
         <asp:Button runat="server" CssClass="btn btn-primary" ID="AddBar_Btn" OnClientClick="return CheckData()" Text="添加贴吧" OnClick="AddBar_Btn_Click" />
