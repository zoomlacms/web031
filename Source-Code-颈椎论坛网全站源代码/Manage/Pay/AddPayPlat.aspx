<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.I.Pay.AddPayPlat, App_Web_juascba0" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
 ...
 <table class="table table-striped table-bordered table-hover">
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator runat="server" ID="Rev_1" ValidationExpression="^[0-9]\d*|0$" Display="Dynamic" ControlToValidate="TxtRate" CssClass="tips" ForeColor="Red" ErrorMessage="只能输入整数"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr >
                    <td >
