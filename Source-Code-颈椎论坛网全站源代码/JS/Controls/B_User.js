...
B_User.prototype = {
    ...
    GetBarUInfo: function (userid, callback) {
        $.post("/Api/UserCheck.ashx", { action: "GetBarUInfo", uid: userid }, function (data) { callback(data); }, "json");
    },
    AddFriend: function (userid, callback) {//添加好友
        $.post("/Api/UserCheck.ashx", { action: "GetBarUInfo", value: userid }, function (data) { callback(data); });
    },
